...
class Secp256k1 extends kp_1.AbstractKeyPair {
    constructor(secretKey) {
        const keyPair = secp.keyFromPrivate(secretKey);
        super(kp_1.AlgorithmType.SECP256K1, Buffer.from(keyPair.getPrivate('hex'), 'hex'), Buffer.from(keyPair.getPublic(true, 'hex'), 'hex'));
    }
    sign(data) {
