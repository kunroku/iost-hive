...
export declare class TransactionHandler {
    #private;
    get event(): StrictEventEmitter<EventEmitter, TransactionEvents, TransactionEvents, "addEventListener" | "removeEventListener", "on" | "addListener" | "removeListener" | "once" | "emit">;
